  ...
  return (
    <>
      <div>
        ...
        <footer className="row-start-3 flex gap-6 flex-wrap items-center justify-center p-20">
          <a className="flex items-center gap-2 hover:underline hover:underline-offset-4" href="https://github.com/sesejose" target="_blank" rel="noopener noreferrer">
            <Image aria-hidden src="/globe.svg" alt="Globe icon" width={16} height={16} />
            GitHub →
          </a>
          <a className="flex items-center gap-2 hover:underline hover:underline-offset-4" href="https://grapixmo.com/" target="_blank">
            <Image aria-hidden src="/globe.svg" alt="File icon" width={16} height={16} />
            Web →
          </a>
          <a className="flex items-center gap-2 hover:underline hover:underline-offset-4" href="https://www.linkedin.com/in/sesejose/" target="_blank" rel="noopener noreferrer">
